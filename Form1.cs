...
namespace RPS
{
    public partial class Form1 : Form
    {
        ...
        // array for thje three random choices, added each twice to increase the randomness. 0 is rock, 5 is rock
        ...
        private void CountDownTimerEvent(object sender, EventArgs e)
        {
            ...
            // keepos score and displays the round
            ...
            if (timePerRound < 1)
            {
                ...
                //cpu images link to the random selection
                switch (CPUChoice)
                {
                    case "rock":
                ...
                // if theres 0 rounds left in the game, the beow if statement will run
                if (rounds > 0)
                {
                    checkGame();
                }
